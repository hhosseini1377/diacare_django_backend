...
urlpatterns = [
                  ...
                  path('api/v1/diacare_history/', GetLandingPageInformation.as_view(), name='information_history'),
                  path('api/v1/account/', include('account.urls')),
                  path('api/v1/article/', include('article.urls')),
                  path('api/v1/freediet/', include('free_diet.urls'), name='free_diet'),
                  path('api/v1/dashboard/', include('dashboard.urls'), name='dashboard'),
                  path('api/v1/diabetes_control/', include('diabetes_control.urls')),
